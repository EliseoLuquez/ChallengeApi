    ...
    public static class CalculateTransaction
    {
        ...
        public static List<string> CalculateChangeDetail(decimal change)
        {
			...
			if (difference >= 100)
			{
				...
				message.Add("Bilhete de BRL 100,00: " + B100);
			}
			...
			if (difference >= 50)
			{
				...
				message.Add("Bilhete de BRL 50,00 : " + B50);
			}
			...
			if (difference >= 20)
			{
				...
				message.Add("Bilhete de BRL 20,00 : " + B20);
			}
			...
			if (difference >= 10)
			{
				...
				message.Add("Bilhete de BRL 10,00 : " + B10);
			}
			...
			if (difference >= (decimal)0.50)
			{
				...
				message.Add("Moedas de BRL 0,50 : " + C50);
			}
			...
			if (difference >= (decimal)0.10)
			{
				...
				message.Add("Moedas de BRL 0,10 : " + C10);
			}
			...
			if (difference >= (decimal)0.05)
			{
				...
				message.Add("Moedas de BRL 0,05 : " + C05);
			}
			...
			if (difference >= (decimal)0.01)
			{
				...
				message.Add("Moedas de BRL 0,01 : " + C01);
			}
